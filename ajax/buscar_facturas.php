<?php
	...
	if (isset($_GET['id'])){
		...
		$del1="delete from factura where id='".$numero_factura."'";
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $sWhere = "";
		 $sWhere.=" WHERE factura.id_cliente=cliente.id";
		if ( $_GET['q'] != "" )
		{
		$sWhere.= " and  (cliente.nombre like '%$q%' or factura.id like '%$q%')";
			
		}
		
		$sWhere.=" order by factura.id desc";
			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td><a href="#" data-toggle="tooltip" data-placement="top" title="<i class='glyphicon glyphicon-phone'></i> <?php echo $telefono_cliente;?><br><i class='glyphicon glyphicon-envelope'></i>  <?php echo $email_cliente;?>" ><?php echo $nombre_cliente. " ". $apellido_cliente;?></a></td>
