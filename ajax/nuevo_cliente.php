<?php
	...
	if (empty($_POST['cedula'])) {
		...
		$sql="INSERT INTO cliente (cedula, nacionalidad, nombre, apellido, telefono, email, direccion) 
		VALUES ('$cedula', '$nacionalidad','$nombre', '$apellido','$telefono','$email','$direccion')";
