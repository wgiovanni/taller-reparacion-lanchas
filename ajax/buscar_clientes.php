<?php
	...
	if (isset($_GET['id'])){
		...
		if ($count==0){
			if ($delete1=mysqli_query($con,"DELETE FROM cliente WHERE id='".$id_cliente."'")){
			?>
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
						...
						$nacionalidad_cliente=$row['nacionalidad'];
					...
					?>
					<input type="hidden" value="<?php echo $id_cliente;?>" id="<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $cedula_cliente;?>" id="cedula_cliente<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $nacionalidad_cliente;?>" id="nacionalidad_cliente<?php echo $id_cliente;?>">
					...
					<tr>
						<td><?php echo $nacionalidad_cliente; ?></td>
