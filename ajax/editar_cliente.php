<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$nacionalidad=mysqli_real_escape_string($con,(strip_tags($_POST["mod_nacionalidad"],ENT_QUOTES)));
		...
		$sql="UPDATE cliente SET cedula = '".$cedula."', nacionalidad='".$nacionalidad."', nombre='".$nombre."', apellido='".$apellido."', telefono='".$telefono."', email='".$email."', direccion='".$direccion."' WHERE id='".$id_cliente."'";
